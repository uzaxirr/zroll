  ...
  return (
    <section id="features" className="pt-8 pb-24 px-6">
      <div className="max-w-[1240px] mx-auto">
        ...
        {/* Bento grid */}
        <div className="flex gap-5" style={{ maxWidth: 1100, margin: "0 auto" }}>
          {/* Left column */}
          <div className="flex flex-col gap-3" style={{ width: 592 }}>
          ...
          {/* Right column */}
          <div className="flex flex-col gap-3" style={{ width: 494 }}>
